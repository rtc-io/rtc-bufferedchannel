...
test('small array is chunked', checkChunks(smallArray, 1, 'uint16'));
...
test('large array is chunked', checkChunks(largeArray, 6, 'uint16'));
...
test('massive array is chunked', checkChunks(massiveArray, 130, 'uint16'));
