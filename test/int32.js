...
test('small array is chunked', checkChunks(smallArray, 1, 'int32'));
...
test('large array is chunked', checkChunks(largeArray, 12, 'int32'));
...
test('massive array is chunked', checkChunks(massiveArray, 259, 'int32'));
