...
test('small array is chunked', checkChunks(smallArray, 1, 'int8'));
...
test('large array is chunked', checkChunks(largeArray, 3, 'int8'));
...
test('massive array is chunked', checkChunks(massiveArray, 65, 'int8'));
